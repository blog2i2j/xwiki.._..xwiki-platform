...
public class TestUtils
{
    ...
    public static final UsernamePasswordCredentials SUPER_ADMIN_CREDENTIALS =
        new UsernamePasswordCredentials("superadmin", "pass".toCharArray());
    ...
    {
        setDefaultCredentials(new UsernamePasswordCredentials(username, password.toCharArray()));
    }
    ...
    public HttpClientContext getHttpClientContext(ClassicHttpRequest request)
    {
        ...
        return ContextBuilder.create()
            .preemptiveBasicAuth(new HttpHost(uri.getScheme(), uri.getHost(), uri.getPort()), this.defaultCredentials)
            .build();
    }

    public void loginAsSuperAdmin()
    {
        login(SUPER_ADMIN_CREDENTIALS.getUserName(), String.valueOf(SUPER_ADMIN_CREDENTIALS.getUserPassword()));
    }

    public void loginAsSuperAdminAndGotoPage(String pageURL)
    {
        loginAndGotoPage(SUPER_ADMIN_CREDENTIALS.getUserName(),
            String.valueOf(SUPER_ADMIN_CREDENTIALS.getUserPassword()), pageURL);
    }

    public void loginAsAdmin()
    {
        login(ADMIN_CREDENTIALS.getUserName(), String.valueOf(ADMIN_CREDENTIALS.getUserPassword()));
    }

    public void loginAsAdminAndGotoPage(String pageURL)
    {
        loginAndGotoPage(ADMIN_CREDENTIALS.getUserName(), String.valueOf(ADMIN_CREDENTIALS.getUserPassword()), pageURL);
    }
    ...
    {
        return getURLToLoginAs(ADMIN_CREDENTIALS.getUserName(), String.valueOf(ADMIN_CREDENTIALS.getUserPassword()));
    }

    public String getURLToLoginAsSuperAdmin()
    {
        return getURLToLoginAs(SUPER_ADMIN_CREDENTIALS.getUserName(),
            String.valueOf(SUPER_ADMIN_CREDENTIALS.getUserPassword()));
    }
    ...
    public String getURLToLoginAsAdminAndGotoPage(final String pageURL)
    {
        return getURLToLoginAndGotoPage(ADMIN_CREDENTIALS.getUserName(),
            String.valueOf(ADMIN_CREDENTIALS.getUserPassword()), pageURL);
    }
    ...
    public void createAdminUser(boolean programming)
    {
        ...
        String password = String.valueOf(ADMIN_CREDENTIALS.getUserPassword());
