...
public abstract class AbstractHttpIT
{
    ...
    {
        UsernamePasswordCredentials credentials = this.testUtils.getDefaultCredentials();
    ...
    protected CloseableHttpResponse executePostXml(String uri, Object object, String userName, String password)
        throws Exception
    {
        return executePostXml(uri, object, new UsernamePasswordCredentials(userName, password.toCharArray()));
    }

    protected CloseableHttpResponse executePostXml(String uri, Object object, UsernamePasswordCredentials credentials)
        throws Exception
    {
        UsernamePasswordCredentials defaultCredentials = this.testUtils.getDefaultCredentials();
        ...
        String password, String formToken) throws Exception
    {
        ...
        MultipartEntityBuilder.create().add
    ...
    protected CloseableHttpResponse executePutXml(String uri, Object object, UsernamePasswordCredentials credentials)
        throws Exception
    {
        UsernamePasswordCredentials defaultCredentials = this.testUtils.getDefaultCredentials();
    ...
    protected CloseableHttpResponse executePutXml(String uri, Object object, String userName, String password)
        throws Exception
    {
        return executePutXml(uri, object, new UsernamePasswordCredentials(userName, password.toCharArray()));
    }
    ...
    protected CloseableHttpResponse executePut(String uri, String string, String mediaType, String userName,
        String password) throws Exception
    {
        return executePut(uri, string, mediaType, new UsernamePasswordCredentials(userName, password.toCharArray()));
    }
    ...
    {
        return executeDelete(uri, new UsernamePasswordCredentials(userName, password.toCharArray()));
    }
